...
// <>
//   <Col style={{padding: `0 ${paddingXL}px`}} xs={{span: 24, offset: 0}} md={{span: 22, offset: 1}} lg={{span: 18, offset: 3}} xxl={{span: 16, offset: 4}}>
//     <Row gutter={[padding, paddingXL]} justify="center">
//       {teachers.map((teacher) => (
//         <Col xs={24} sm={12} lg={8} xxl={6} key={teacher.path}>
//           <Card
//             hoverable
//             style={{height: "100%", display: "flex", flexDirection: "column"}}
//             styles={{
