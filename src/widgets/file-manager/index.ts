import CopyCutPasteButtons from "./ui/copy-cut-paste-buttons/copy-cut-paste-buttons";
...
export {FileManager, CreateFolderButton, DeleteFilesButton, UploadFilesButton, FilePreview, CopyCutPasteButtons, RenameButton};